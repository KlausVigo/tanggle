...
This vignette illustrates all the functions in the R package ***tanggle***, and [rovide some examples on how to plot both explicit and implicit networks. The split network plots should take most of the functions compatible with unrooted trees in ggtree. The explicit network plots are phylogram or slanted.
